...
class AgentClient(BaseLLMModel):
    def __init__(self, model_name, openai_api_key, user_name="") -> None:
        ...
        # self.summarize_chain = load_summarize_chain(self.cheap_llm, chain_type="map_reduce",
        #                                             return_intermediate_steps=True, map_prompt=PROMPT,
    ...
    def get_answer_at_once(self):
        ...
        agent = initialize_agent(self.tools, self.llm, agent=AgentType.STRUCTURED_CHAT_ZERO_SHOT_REACT_DESCRIPTION,
                                 verbose=True)
    ...
    def get_answer_stream_iter(self):
        ...
        def thread_func():
            ...
            agent = initialize_agent(self.tools, self.llm, agent=AgentType.STRUCTURED_CHAT_ZERO_SHOT_REACT_DESCRIPTION,
                                     verbose=True, callback_manager=manager)
            try:
                reply = agent.run(input=f"{question} Reply in 简体中文")
